...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (newsletterForm) {
    newsletterForm.addEventListener("submit", (e) => {
      e.preventDefault();
      alert("Cảm ơn! Chúng tôi đã ghi nhận email.");
      e.target.reset();
    });
  }
  ...
  document.getElementById("cartModal").addEventListener("click", (ev) => {
    if (ev.target === document.getElementById("cartModal")) closeCart();
  });
});
